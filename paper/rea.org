...
affect the other variables in other unexpected ways, showing that the Neural Network
...
elements within the floorplan rather than using it for rent prediction. The earliest example of the use of Neural Networks for rent price prediction the author
...
spite of the hardships of interpreting Neural Networks, simply due to their
...
This subsection will explain the architecture of the Neural network we used and the preprocessing and augmentation steps we performed.
...
sigmoid layer discussed in [[Methodology]]. The neural network
...
the dataset. They also provide insight into how the Neural Network is
...
largest downward changes due to the Neural Network, and afterward, we will look
...
might be that the neural network was considering the floorplan as a whole,
...
with the new features. However, under any circumstances where it might be easier to
...
to gather a dataset of tabular features but could obtain the floorplans.
...
#+CAPTION: This figure shows the Minimal and maximal predictions that the Neural network made.
#+begin_sidewaysfigure
[[./assets/rand_neg_top_100.png]]
[[./assets/rand_top_100.png]]
#+end_sidewaysfigure
...
#+CAPTION: This figure shows the predictions where an inclusion of the Neural network's predictions introduced the largest changes.
#+begin_sidewaysfigure
[[./assets/underpreds.png]]
[[./assets/overpreds.png]]
#+end_sidewaysfigure
