...
banks have methods of assessing the price of a property as well, for example for their
...
However, in other contexts, operating on a larger scale, real-estate prices
...
properties at the apartment level, as this kind of information is hard to obtain and formulate into distinct features.
...
available website. Then we devised some minor adjustments to a widely used neural
...
** TODO Table with test data results
** TODO Maybe Some other stats like improvement in prediction in Yen
...
* TODO translate japanese citations to english
\printbibliography
