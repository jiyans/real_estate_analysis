...
# ╔═╡ 9f1696de-64c8-11ec-353f-f5de9df5f93f
begin
	using DataFrames
	using Plots
	using GLM
...
# ╔═╡ 9f1696b6-64c8-11ec-19d6-11740ba0f044
html"""
...
# ╔═╡ 3c0eebee-ff72-4dfe-9caa-1bcc0a0df065
df = CSV.read("../data/suumo.csv", DataFrame)

# ╔═╡ 26c6dc3e-c4aa-4809-9362-771fad2cdd48


# ╔═╡ 127fd815-c870-4bde-9f4b-1abe6389d3f6
begin
	
	df[!,:station] = categorical(df[!,:station])
	df[!,:apt_style] = categorical(df[!,:apt_style])
	df[!, :method] = categorical(df[!, :method])

	regformula = @formula(apt_rent ~ apt_size )#b_age + b_no_floors + apt_size + 			apt_admin_price + apt_floor + time_to_station*method )
	rr1 = lm(@formula(apt_rent ~ apt_size), df)
end

# ╔═╡ d056ab47-f56b-4800-9948-5f4e290501e0


# ╔═╡ fda62722-93ef-44f8-be2b-01e2246e86b2
unique(df[!, :method])

# ╔═╡ f5f8c8d7-3d0f-430d-8232-d1671cc94c72


# ╔═╡ 19e49e93-c108-4548-b0b2-67e44b9bb013


# ╔═╡ c9608451-a93a-40ef-b80a-bc89a8802b71
begin
	scatter(df[!, :apt_rent], df[!, :apt_size])
	# plot!(x->rr1.coef[1]+rr1.coef[2]*x)
end

# ╔═╡ cccd4ac3-c9a4-4281-9bf2-ae8562eb9b93


# ╔═╡ 78e71906-9fff-4973-bd23-12077099c5eb
plot(df[!, :apt_rent], df[!, :apt_size], markerype="o" )

# ╔═╡ 0a9ffb96-d702-4c80-98d6-23f0dd6a5ed2


# ╔═╡ 87a229ad-0b29-449d-b833-346759db1308


# ╔═╡ 1649644c-af53-4264-a013-75675c7e5217
regtable(rr1,rr2; renderSettings = asciiOutput())

# ╔═╡ a3821643-8284-4146-bc95-938fef3468aa
rr4

# ╔═╡ a9692804-a9cc-4920-9821-85a4f1079177
rr1.coef

# ╔═╡ 8795cfdc-0b94-41f3-a8fe-70f41488b9d6
rr1

# ╔═╡ 6798c6ad-ff01-4d79-92ba-ca9c8e49f544


# ╔═╡ 40ae8b3b-b81d-4bee-97b8-819300e6d27e


# ╔═╡ 1d050fb7-8f02-4301-bdb6-8d12bca54b07


# ╔═╡ 2cc6133b-680e-4866-b275-d7528a045a65


# ╔═╡ f2d7135c-d30e-4a47-af28-11a242c9f6f7


# ╔═╡ 4e5ab8bc-515f-431b-8d2d-6b2cadef453e
